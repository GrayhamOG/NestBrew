  ...
  <div class="card">
    <form method="POST" action="{{ route('admin.menu.store') }}">
      ...
      <div class="row">
        <div class="form-group">
          ...
          <input type="text" name="name" value="{{ old('name') }}"
                 placeholder="Signature Nest Latte" required/>
      ...
      <div class="row">
        ...
        <div class="form-group">
          ...
          <input type="number" name="price" value="{{ old('price') }}"
                 placeholder="145" min="0" step="0.01" required/>
      ...
      <div class="form-group">
        ...
        <textarea name="description" placeholder="Describe the item...">{{ old('description') }}</textarea>
      </div>
